package com.howard.retrofitdemo.model;
...
/**
 * This class is used for representing a Movie details obtained from the movieList layer
 * by a movies list. It contains less movieList than a MovieDetails
 *
